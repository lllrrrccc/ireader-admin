...
<div class="modal-overlay" id="modal-add-article">
    <div class="modal" style="max-width:800px;">
        <div class="modal-header">
            <span class="modal-title" id="article-modal-title">新增文章</span>
            <button class="modal-close" onclick="closeModal('modal-add-article')"><i class="ri-close-line"></i></button>
        </div>
        <div class="modal-body" id="article-modal-body" style="padding:20px;max-height:70vh;overflow-y:auto;">
            <!-- Step 1: 选择分类 + 粘贴文本 -->
            <div id="add-article-step1">
                ...
                <div class="form-group" id="article-paste-group">
                    <label class="form-label">粘贴文章内容 <span style="color:var(--danger);">*</span></label>
                    <textarea class="form-textarea" id="article-paste-text" rows="10" placeholder="请将文章全文粘贴到此处"></textarea>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">粘贴后点击下一步，系统将自动按段落分好段</div>
                </div>
            </div>
            <!-- Step 2: 段落编辑 -->
            <div id="add-article-step2" style="display:none;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
                    <div style="font-size:14px;font-weight:600;color:var(--text-primary);">段落编辑</div>
                    <button class="btn btn-secondary btn-sm" onclick="addArticlePara()"><i class="ri-add-line"></i> 添加段落</button>
                </div>
                <div id="article-edit-paragraphs" style="display:flex;flex-direction:column;gap:12px;max-height:50vh;overflow-y:auto;">
                    <!-- 段落列表由 JS 动态生成 -->
                </div>
                <div style="margin-top:16px;padding:12px;background:var(--bg);border-radius:8px;border:1px solid var(--border);">
                    <div style="font-size:12px;color:var(--text-muted);margin-bottom:8px;">操作说明</div>
                    <div style="font-size:12px;color:var(--text-secondary);line-height:1.6;">
                        <i class="ri-add-line" style="margin-right:4px;"></i>点击右上角"添加段落"按钮新增段落<br>
                        <i class="ri-delete-bin-line" style="margin-right:4px;"></i>点击删除按钮移除段落
                    </div>
                </div>
            </div>
            <!-- Step 3: 填写书籍信息 -->
            <div id="add-article-step3" style="display:none;">
                ...
                <div class="form-group">
                    ...
                    <div class="multiselect-dropdown" id="article-cat" style="position:relative;">
                        ...
                        <div class="multiselect-options" id="article-cat-opts" style="display:none;position:fixed;z-index:10000;background:#fff;border:1px solid var(--border);border-radius:var(--radius);max-height:240px;overflow-y:auto;box-shadow:0 8px 24px rgba(0,0,0,0.15);min-width:180px;">
                            <div class="article-cat-group" data-lang="zh" style="padding:8px 12px;border-bottom:1px solid var(--border);font-size:12px;color:var(--text-muted);font-weight:600;">中文</div>
                            <label class="article-cat-item" data-lang="zh" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '中文-文学')"> 文学</label>
                            <label class="article-cat-item" data-lang="zh" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '中文-艺术')"> 艺术</label>
                            <label class="article-cat-item" data-lang="zh" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '中文-人文社科')"> 人文社科</label>
                            <label class="article-cat-item" data-lang="zh" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '中文-自然科学')"> 自然科学</label>
                            <div class="article-cat-group" data-lang="en" style="padding:8px 12px;border-bottom:1px solid var(--border);border-top:1px solid var(--border);font-size:12px;color:var(--text-muted);font-weight:600;">英文</div>
                            <label class="article-cat-item" data-lang="en" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '英文-英语周报时文')"> 英语周报时文</label>
                            <label class="article-cat-item" data-lang="en" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '英文-外研社分级阅读')"> 外研社分级阅读</label>
                            <label class="article-cat-item" data-lang="en" style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="radio" name="article-cat" onchange="updateRadioText('article-cat', '英文-原版名著')"> 原版名著</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label">书籍标签</label>
                    <div class="multiselect-dropdown" id="article-tag" style="position:relative;">
                        <div class="multiselect-trigger" style="display:flex;align-items:center;justify-content:space-between;padding:8px 12px;border:1px solid var(--border);border-radius:var(--radius);cursor:pointer;background:#fff;" onclick="toggleDropdown(this, 'article-tag-opts')">
                            <span id="article-tag-text" style="font-size:13px;color:var(--text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;min-width:0;">选填（可多选）</span>
                            <i class="ri-arrow-down-s-line" style="color:var(--text-muted);flex-shrink:0;margin-left:4px;"></i>
                        </div>
                        <div class="multiselect-options" id="article-tag-opts" style="display:none;position:fixed;z-index:10000;background:#fff;border:1px solid var(--border);border-radius:var(--radius);max-height:240px;overflow-y:auto;box-shadow:0 8px 24px rgba(0,0,0,0.15);min-width:180px;">
                            <label style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="checkbox" onchange="updateTagText('article-tag')"> 中小学指导书目</label>
                            <label style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="checkbox" onchange="updateTagText('article-tag')"> 教师推荐书目</label>
                            <label style="display:flex;align-items:center;gap:8px;padding:8px 12px;cursor:pointer;font-size:13px;transition:background 0.2s;" onmouseover="this.style.background='var(--bg)'" onmouseout="this.style.background=''"><input type="checkbox" onchange="updateTagText('article-tag')"> 新课标必读</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer" id="article-modal-footer">
            ...
            <button class="btn btn-primary" onclick="showArticleStep2()">下一步 <i class="ri-arrow-right-line"></i></button>
        </div>
    </div>
</div>
...
<div class="steps" style="margin-bottom:24px;">
    ...
    <div class="step" id="batch-step-4">
...
<!-- Step 1: 选择分类 -->
<div id="batch-cat-step">
    <div class="card" style="max-width:480px;margin:0 auto;">
        <div class="card-body" style="text-align:center;padding:60px 40px;">
            <i class="ri-book-mark-line" style="font-size:48px;color:var(--primary);margin-bottom:20px;"></i>
            <div style="font-size:16px;font-weight:600;color:var(--text-primary);margin-bottom:8px;">请选择基础分类的一级分类</div>
            <div style="font-size:13px;color:var(--text-secondary);margin-bottom:32px;">该分类将决定后续填写字段的中英文显示规则</div>
            <div style="display:flex;gap:16px;justify-content:center;">
                <div style="width:140px;padding:20px;border:2px solid var(--border);border-radius:12px;cursor:pointer;transition:all 0.2s;" onmouseover="this.style.borderColor='var(--primary)'" onmouseout="this.style.borderColor='var(--border)'" onclick="selectBatchLang('zh')">
                    <i class="ri-china-line" style="font-size:32px;color:var(--primary);"></i>
                    <div style="font-size:14px;font-weight:600;margin-top:8px;">中文</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">中文书籍</div>
                </div>
                <div style="width:140px;padding:20px;border:2px solid var(--border);border-radius:12px;cursor:pointer;transition:all 0.2s;" onmouseover="this.style.borderColor='var(--primary)'" onmouseout="this.style.borderColor='var(--border)'" onclick="selectBatchLang('en')">
                    <i class="ri-english-input" style="font-size:32px;color:var(--primary);"></i>
                    <div style="font-size:14px;font-weight:600;margin-top:8px;">英文</div>
                    <div style="font-size:12px;color:var(--text-muted);margin-top:4px;">英文书籍</div>
                </div>
            </div>
        </div>
    </div>
...
<!-- Step 2: 上传文件 -->
<div id="batch-upload-step" style="display:none;">
    <div class="card">
        <div class="card-body">
...
<div id="batch-edit-step" style="display:none;">
    <div class="card">
            ...
            <table class="data-table" id="batch-edit-table">
                <thead>
                    <tr>
                        ...
                        <th style="width:180px;">
                            <div style="display:flex;flex-direction:column;gap:4px;">
                                <div class="multiselect-dropdown" id="batch-bulk-grade" style="position:relative;">
                                    <div class="multiselect-trigger" style="display:flex;align-items:center;justify-content:space-between;padding:6px 8px;border:1px solid var(--border);border-radius:var(--radius);cursor:pointer;background:#fff;font-size:13px;" onclick="toggleDropdown(this, 'batch-bulk-grade-opts')">
                                        <span id="batch-bulk-grade-text" style="font-size:12px;color:var(--text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;min-width:0;">设置适用年级</span>
                                        <i class="ri-arrow-down-s-line" style="color:var(--text-muted);flex-shrink:0;margin-left:4px;font-size:12px;"></i>
                                    </div>
                                    <div class="multiselect-options" id="batch-bulk-grade-opts" style="display:none;position:fixed;z-index:10000;background:#fff;border:1px solid var(--border);border-radius:var(--radius);max-height:200px;overflow-y:auto;box-shadow:0 8px 24px rgba(0,0,0,0.15);min-width:160px;">
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学1年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学2年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学3年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学4年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学5年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 小学6年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 初中1年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 初中2年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 初中3年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 高中一年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 高中二年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 高中三年级</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 大学生</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateGradeText('batch-bulk-grade')"> 在职人员</label>
                                    </div>
                                </div>
                                <span>适用年级</span>
                            </div>
                        ...
                        <th style="width:180px;">
                            <div style="display:flex;flex-direction:column;gap:4px;">
                                <div class="multiselect-dropdown" id="batch-bulk-tag" style="position:relative;">
                                    <div class="multiselect-trigger" style="display:flex;align-items:center;justify-content:space-between;padding:6px 8px;border:1px solid var(--border);border-radius:var(--radius);cursor:pointer;background:#fff;font-size:13px;" onclick="toggleDropdown(this, 'batch-bulk-tag-opts')">
                                        <span id="batch-bulk-tag-text" style="font-size:12px;color:var(--text-secondary);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1;min-width:0;">设置书籍标签</span>
                                        <i class="ri-arrow-down-s-line" style="color:var(--text-muted);flex-shrink:0;margin-left:4px;font-size:12px;"></i>
                                    </div>
                                    <div class="multiselect-options" id="batch-bulk-tag-opts" style="display:none;position:fixed;z-index:10000;background:#fff;border:1px solid var(--border);border-radius:var(--radius);max-height:200px;overflow-y:auto;box-shadow:0 8px 24px rgba(0,0,0,0.15);min-width:160px;">
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateTagText('batch-bulk-tag')"> 中小学指导书目</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateTagText('batch-bulk-tag')"> 教师推荐书目</label>
                                        <label style="display:flex;align-items:center;gap:6px;padding:6px 10px;cursor:pointer;font-size:12px;"><input type="checkbox" onchange="updateTagText('batch-bulk-tag')"> 新课标必读</label>
                                    </div>
                                </div>
                                <span>书籍标签</span>
                            </div>
        ...
        <div class="card-footer" style="display:flex;justify-content:flex-end;align-items:center;padding:12px 20px;border-top:1px solid var(--border);">
            <div style="display:flex;gap:8px;">
                <button class="btn btn-secondary" onclick="showBatchStep2()"><i class="ri-arrow-left-line"></i> 上一步</button>
                <button class="btn btn-primary" onclick="showBatchStep4()"><i class="ri-save-line"></i> 确定新增</button>
            </div>
        </div>
    </div>
</div>
...
<div class="page-title">
    ...
    <div style="display:flex;align-items:center;gap:12px;font-size:14px;">
        <span style="font-weight:600;color:var(--text-primary);">小王子</span>
        <span style="color:var(--text-muted);">The Little Prince</span>
        <span style="color:var(--text-muted);">— 圣埃克苏佩里</span>
    </div>
</div>

<div style="display:flex;gap:16px;height:calc(100vh - 200px);min-height:500px;">
    <div class="card" style="width:220px;flex-shrink:0;display:flex;flex-direction:column;">
        <div class="card-header"><span class="card-title">📑 Chapters</span></div>
        <div class="card-body" style="flex:1;overflow-y:auto;padding:8px;">
            <div class="tree-item active" style="padding:10px 12px;border-radius:6px;cursor:pointer;margin-bottom:4px;background:rgba(37,99,235,0.08);border:1px solid var(--primary);" onclick="selectChapter(this)">
                <div style="font-weight:500;font-size:13px;">Chapter I</div>
                <div style="font-size:12px;color:var(--text-muted);">The Snake and the Elephant</div>
            </div>
            <div class="tree-item" style="padding:10px 12px;border-radius:6px;cursor:pointer;margin-bottom:4px;" onclick="selectChapter(this)">
                <div style="font-weight:500;font-size:13px;">Chapter II</div>
                <div style="font-size:12px;color:var(--text-muted);">The Little Prince's Planet</div>
            </div>
            <div class="tree-item" style="padding:10px 12px;border-radius:6px;cursor:pointer;margin-bottom:4px;" onclick="selectChapter(this)">
                <div style="font-weight:500;font-size:13px;">Chapter III</div>
                <div style="font-size:12px;color:var(--text-muted);">The Rose</div>
            </div>
        </div>
    </div>
    <div class="card" style="flex:1;display:flex;flex-direction:column;">
        <div class="card-header" style="display:flex;justify-content:space-between;align-items:center;">
            <span class="card-title">📝 Chapter I - The Snake and the Elephant</span>
            <div style="display:flex;gap:8px;">
                <button class="btn btn-secondary btn-sm" onclick="document.getElementById('translation-import').click()"><i class="ri-file-upload-line"></i> 导入本章译文</button>
                <input type="file" id="translation-import" accept=".txt" style="display:none;" onchange="importTranslation(this)">
                <button class="btn btn-primary btn-sm" onclick="saveTranslation()"><i class="ri-save-line"></i> 保存译文</button>
            </div>
        </div>
        <div class="card-body" style="flex:1;overflow-y:auto;padding:20px 24px;" id="translation-editor">
            <div style="display:flex;flex-direction:column;gap:20px;">
                <div class="translation-para" style="display:flex;gap:16px;padding:16px;background:var(--bg);border-radius:8px;border:1px solid var(--border);">
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">原文段落 1</div>
                        <div style="font-size:14px;line-height:1.8;color:var(--text-primary);padding:12px;background:#f8f9fa;border-radius:6px;flex:1;">When I was six years old, in a book on primeval forests called True Stories, I saw a magnificent drawing. It was a picture of a boa constrictor in the act of swallowing an animal. Here is a copy of the drawing.</div>
                    </div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">译文</div>
                        <textarea class="form-textarea" rows="4" placeholder="请输入译文..." style="font-size:14px;line-height:1.8;flex:1;resize:vertical;">当我还只有六岁的时候，在一本描写原始森林的名叫《真实的故事》的书中，看到了一副精彩的插画，画的是一条蟒蛇正在吞食一只大野兽。</textarea>
                    </div>
                </div>
                <div class="translation-para" style="display:flex;gap:16px;padding:16px;background:var(--bg);border-radius:8px;border:1px solid var(--border);">
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">原文段落 2</div>
                        <div style="font-size:14px;line-height:1.8;color:var(--text-primary);padding:12px;background:#f8f9fa;border-radius:6px;flex:1;">In the book it said: "Boa constrictors swallow their prey whole, without chewing it. After that they are not able to move, and they sleep through the six months that they need for digestion."</div>
                    </div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">译文</div>
                        <textarea class="form-textarea" rows="4" placeholder="请输入译文..." style="font-size:14px;line-height:1.8;flex:1;resize:vertical;">这本书中写道："这些蟒蛇把它们的猎获物不加咀嚼地囫囵吞下，而后就不能再动弹了；它们就在长长的六个月的睡眠中消化这些食物。"</textarea>
                    </div>
                </div>
                <div class="translation-para" style="display:flex;gap:16px;padding:16px;background:var(--bg);border-radius:8px;border:1px solid var(--border);">
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">原文段落 3</div>
                        <div style="font-size:14px;line-height:1.8;color:var(--text-primary);padding:12px;background:#f8f9fa;border-radius:6px;flex:1;">I pondered deeply, then, over the adventures of the jungle. And after some work with a colored pencil, I succeeded in making my first drawing. My Drawing Number One. It looked like this:</div>
                    </div>
                    <div style="flex:1;display:flex;flex-direction:column;gap:8px;">
                        <div style="font-size:12px;color:var(--text-muted);font-weight:500;">译文</div>
                        <textarea class="form-textarea" rows="4" placeholder="请输入译文..." style="font-size:14px;line-height:1.8;flex:1;resize:vertical;">当时，我对丛林中的奇遇想得很多，于是，我也用彩色铅笔画出了我的第一副图画。我的第一号作品。它是这样的：</textarea>
                    </div>
                </div>
            </div>
        </div>
